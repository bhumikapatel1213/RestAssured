...
public class CreateOneProduct {
	...
	softassert.assertEquals(ActualProductName, createPayLoadMap().get("name"), "Product Name is not matching");
	
	String ActualProductDescription = jp.getString("description");
	System.out.println("Product Description :" + ActualProductDescription);
	softassert.assertEquals(ActualProductDescription, createPayLoadMap().get("description"), "Product Description is not matching");
	
	String ActualProductPrice = jp.getString("price");
	System.out.println("Product Price:" + ActualProductPrice);
	softassert.assertEquals(ActualProductPrice, createPayLoadMap().get("price"), "Product Price is not matching");
	}
